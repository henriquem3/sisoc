...
const Routes: React.FC = () => (
  <Switch>
    ...
    <Route path="/ocorrenciatipo/criar" needAuthentication component={CriarOcorrenciaTipo} />
    <Route path="/setor" exact needAuthentication component={Setor} />
    <Route path="/setor/criar" needAuthentication component={CriarSetor} />
    <Route path="/usuariotipo" exact needAuthentication component={UsuarioTipo} />
    <Route path="/usuariotipo/criar" needAuthentication component={CriarUsuarioTipo} />
